const REVIEWS = [
  {
    name: '[Имя родителя]',
    text: 'Ребёнок сам просит «поиграть с Анастасией» — раньше от логопедических занятий были слёзы, теперь наоборот.',
  },
  {
    name: '[Имя родителя]',
    text: 'Звук «Р» поставили за несколько недель, всё удобно, занимались онлайн вечером после сада.',
  },
  {
    name: '[Имя родителя]',
    text: 'Очень понравился формат: короткие занятия, понятные задания на дом, всегда на связи в чате.',
  },
]
